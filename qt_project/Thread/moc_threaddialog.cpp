...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ThreadDialog_t, stringdata) + ofs \
...
const QMetaObject ThreadDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ThreadDialog.data,
      qt_meta_data_ThreadDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThreadDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadDialog.stringdata))
