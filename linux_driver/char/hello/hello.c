 ...
 * @version: v0.01
 * @Author: zhengyang
 * @Date: 2021-06-10 11:03:03
 * @LastEditors: zhengyang
 * @LastEditTime: 2021-06-10 18:16:39
 */
...
dev_t devno;
int major = 150;
const char DEVNAME[] = "hello";
char data[64]  = "hello usr layer, this is a message from keneral!";
...
// mei yi ge inode only one yi ge she beizho duiyign  inode  devn  dev name file_ops
